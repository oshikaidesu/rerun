...
impl FFmpegProcessAndListener {
    fn new(
        ...
        source_yuv: Option<(
            crate::decode::YuvRange,
            crate::decode::YuvMatrixCoefficients,
        )>,
    ) -> Result<Self, Error> {
        ...
        let (pixel_format, ffmpeg_pix_fmt) =
            if let Some(chroma_subsampling) = encoding_details.and_then(|e| e.chroma_subsampling) {
                ...
                let (layout, ffmpeg_pix_fmt) = match (chroma_subsampling, full) {
                    (ChromaSubsamplingModes::Yuv444, true) => {
                        (crate::decode::YuvPixelLayout::Y_U_V444, "yuvj444p")
                    }
                    (ChromaSubsamplingModes::Yuv444, false) => {
                        (crate::decode::YuvPixelLayout::Y_U_V444, "yuv444p")
                    }
                    (ChromaSubsamplingModes::Yuv422, true) => {
                        (crate::decode::YuvPixelLayout::Y_U_V422, "yuvj422p")
                    }
                    (ChromaSubsamplingModes::Yuv422, false) => {
                        (crate::decode::YuvPixelLayout::Y_U_V422, "yuv422p")
                    }
                    (ChromaSubsamplingModes::Yuv420, true) => {
                        (crate::decode::YuvPixelLayout::Y_U_V420, "yuvj420p")
                    }
                    (ChromaSubsamplingModes::Yuv420, false) => {
                        (crate::decode::YuvPixelLayout::Y_U_V420, "yuv420p")
                    }
                    (ChromaSubsamplingModes::Monochrome, _) => {
